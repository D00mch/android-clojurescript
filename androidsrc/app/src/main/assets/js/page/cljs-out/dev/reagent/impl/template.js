...
var G__13308 = o;
(G__13308[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__13310__i < G__13310__a.length) {G__13310__a[G__13310__i] = arguments[G__13310__i + 0]; ++G__13310__i;}
  args = new cljs.core.IndexedSeq(G__13310__a,0,null);
} 
...
var G__13312 = o;
(G__13312[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__13317 = props;
var G__13317__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13317,cljs.core.cst$kw$id,id):G__13317);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13317__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__13318){
...
var props = map__13319__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13319__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__13319,map__13319__$1,props,class$){
return (function (c){
...
});})(map__13319,map__13319__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__13321){
var map__13322 = p__13321;
var map__13322__$1 = (((((!((map__13322 == null))))?(((((map__13322.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13322.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13322):map__13322);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13322__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__13322,map__13322__$1,on_write){
return (function (){
...
});})(node_value,map__13322,map__13322__$1,on_write))
);
} else {
...
var G__13325 = jsprops;
(G__13325["defaultValue"] = value);

(G__13325["onChange"] = ((function (G__13325,v,value,on_change){
return (function (p1__13324_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13324_SHARP_);
});})(G__13325,v,value,on_change))
);
...
var vec__13328 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13328,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13328,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13328,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___13332 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___13332 == null)){
} else {
var key_13333 = temp__5461__auto___13332;
(jsprops["key"] = key_13333);
}
...
var temp__5461__auto___13334 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___13334 == null)){
} else {
var key_13335 = temp__5461__auto___13334;
reagent.impl.template.oset(jsprops,"key",key_13335);
}
...
var G__13336 = reagent.impl.template.__GT_NativeWrapper();
(G__13336["name"] = c);
...
var G__13337 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13337) : reagent.impl.template.as_element.call(null,G__13337));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13341){
var G__13342 = cljs.core.first(seq13341);
var seq13341__$1 = cljs.core.next(seq13341);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13342,seq13341__$1);
});
...
break;
default:
var G__13348 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__13348;
continue;
...
var n__4607__auto___13350 = a.length;
var i_13351 = (0);
while(true){
if((i_13351 < n__4607__auto___13350)){
(a[i_13351] = reagent.impl.template.as_element((a[i_13351])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___13353 = a.length;
var i_13354 = (0);
while(true){
if((i_13354 < n__4607__auto___13353)){
var val_13355 = (a[i_13354]);
if(((cljs.core.vector_QMARK_(val_13355)) && ((reagent.impl.template.key_from_vec(val_13355) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_13354] = reagent.impl.template.as_element(val_13355));

var G__13356 = (i_13354 + (1));
i_13354 = G__13356;
continue;
} else {
}
...
var ctx = ({});
var vec__13357 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13357,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13357,(1),null);
...
var G__13360 = (cljs.core.count(argv) - first_child);
switch (G__13360) {
case (0):
...
case (1):
var G__13361 = comp;
var G__13362 = jsprops;
var G__13363 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__13361,G__13362,G__13363) : reagent.impl.template.global$module$react.createElement.call(null,G__13361,G__13362,G__13363));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__13360){
