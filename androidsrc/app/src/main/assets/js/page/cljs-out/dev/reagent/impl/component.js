...
if((i < len)){
var k = (ks[i]);
var G__13240 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13241 = (i + (1));
m = G__13240;
i = G__13241;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__13242 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__13242) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__13242));
})());
} else {
var v = temp__5459__auto__;
...
return (G__13244__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13246 = c;
var G__13246__$1 = (((G__13246 == null))?null:G__13246.prototype);
if((G__13246__$1 == null)){
return null;
} else {
return (G__13246__$1["render"]);
}
})() == null)))));
});
...
var G__13248 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13248) : reagent.impl.component.as_element.call(null,G__13248));
};
...
var _STAR_current_component_STAR__orig_val__13254 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13255 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13255;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13254;
}});
...
return ((function (G__13256,G__13256__$1){
...
var c = this;
var G__13261_13263 = (c["cljsRatom"]);
if((G__13261_13263 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13261_13263);
}
...
var renders_13265 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_13266 = cljs.core.first(cljs.core.vals(renders_13265));
if((cljs.core.count(renders_13265) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13265))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13266)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13266], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__13264 = name;
switch (G__13264) {
case "":
...
var G__13269 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__13269) : reagent.impl.component.global$module$create_react_class.call(null,G__13269));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__13270 = fiber;
var G__13270__$1 = (((G__13270 == null))?null:(G__13270["type"]));
if((G__13270__$1 == null)){
return null;
} else {
return (G__13270__$1["displayName"]);
}
})();
var parent = (function (){var G__13271 = fiber;
if((G__13271 == null)){
return null;
} else {
return (G__13271["return"]);
}
})();
var path = (function (){var G__13272 = parent;
var G__13272__$1 = (((G__13272 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__13272) : reagent.impl.component.fiber_component_path.call(null,G__13272)));
if((G__13272__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13272__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__13274 = c;
if((G__13274 == null)){
return null;
} else {
return (G__13274["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__13275._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__13277 = c;
if((G__13277 == null)){
return null;
} else {
return (G__13277["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__13279 = c;
if((G__13279 == null)){
return null;
} else {
return G__13279._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__13281 = instance;
if((G__13281 == null)){
return null;
} else {
return (G__13281["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__13282 = instance;
if((G__13282 == null)){
return null;
} else {
return G__13282._currentElement;
}
}
})();
var name = (function (){var G__13283 = elem;
var G__13283__$1 = (((G__13283 == null))?null:(G__13283["type"]));
if((G__13283__$1 == null)){
return null;
} else {
return (G__13283__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__13285 = elem;
if((G__13285 == null)){
return null;
} else {
return (G__13285["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__13286._owner;
}
}
})();
var path = (function (){var G__13287 = owner;
var G__13287__$1 = (((G__13287 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__13287) : reagent.impl.component.component_path.call(null,G__13287)));
if((G__13287__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13287__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__13288 = c;
var G__13288__$1 = (((G__13288 == null))?null:G__13288.constructor);
if((G__13288__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13288__$1);
}
}
})();
