...
return cljs.core.map.call(null,(function (p1__10944_SHARP_){
return html_coll.item(p1__10944_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__10945_SHARP_);
...
var ctx_10946 = cvs.getContext("2d");
ctx_10946.fillStyle = color;

ctx_10946.fillRect((0),(0),size,size);
