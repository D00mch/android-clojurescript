...
var G__12066 = devtools.prefs.pref.call(null,v);
v = G__12066;
continue;
} else {
return v;
...
}catch (e12069){var _e__11080__auto__ = e12069;
return false;
}})();
...
}catch (e12073){var _e__11080__auto__ = e12073;
return false;
}})();
...
}catch (e12075){var _e__11080__auto__ = e12075;
return false;
}}
}
});
...
var vec__12077 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12077,(0),null);
var name = cljs.core.nth.call(null,vec__12077,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12080_SHARP_);
}),template);
});
