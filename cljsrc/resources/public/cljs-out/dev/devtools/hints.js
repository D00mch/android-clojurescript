...
var file = cljs.core.get.call(null,map__13146__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13146__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13146__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e13145){var _e = e13145;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___13148 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___13148)){
var seen_errors_13149 = temp__5455__auto___13148;
if(cljs.core.truth_(seen_errors_13149.has(self))){
} else {
seen_errors_13149.add(self);

var temp__5457__auto___13150 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___13150)){
var sense_13151 = temp__5457__auto___13150;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13151)].join('');
} else {
}
}
} else {
