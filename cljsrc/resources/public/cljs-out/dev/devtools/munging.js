...
var o11961 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11961["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11962 = temp__5455__auto____$1;
return (o11962["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11073__auto__ = f;
return (o__11073__auto__["toString"]).call(o__11073__auto__);
} else {
return "";
}
}catch (e11963){var _ = e11963;
return "";
}});
...
try{var o__11073__auto___11965 = t;
(o__11073__auto___11965["cljs$lang$ctorPrWriter"]).call(o__11073__auto___11965,t,writer);
}catch (e11964){var __11966 = e11964;
}
...
var char_code = (function (){var o__11073__auto__ = (new String(char$));
return (o__11073__auto__["charCodeAt"]).call(o__11073__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11073__auto__ = String;
return (o__11073__auto__["fromCharCode"]).call(o__11073__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11967 = num_code;
switch (G__11967) {
case (1):
return (185);
...
var o__11073__auto__ = String;
return (o__11073__auto__["fromCharCode"]).call(o__11073__auto__,superscript_code);
});
/**
...
}catch (e11969){var _e__11080__auto__ = e11969;
return false;
}})())){
...
var vec__11970 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11970,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o11973 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11973["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11974 = temp__5455__auto____$1;
return (o11974["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___11981 = arguments.length;
var i__4731__auto___11982 = (0);
while(true){
if((i__4731__auto___11982 < len__4730__auto___11981)){
args__4736__auto__.push((arguments[i__4731__auto___11982]));

var G__11983 = (i__4731__auto___11982 + (1));
i__4731__auto___11982 = G__11983;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11977){
var vec__11978 = p__11977;
var ns_detector = cljs.core.nth.call(null,vec__11978,(0),null);
...
var G__11984 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11985 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11984;
remaining_tokens = G__11985;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11975){
var G__11976 = cljs.core.first.call(null,seq11975);
var seq11975__$1 = cljs.core.next.call(null,seq11975);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11976,seq11975__$1);
});
...
var vec__11989 = cljs.core.split_with.call(null,(function (p1__11988_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11988_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11989,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11989,(1),null);
...
var vec__11995 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11995,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11995,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11998 = cljs.core.rest.call(null,remaining_tokens);
var G__11999 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11998;
name_tokens = G__11999;
continue;
} else {
...
var vec__12002 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12002,(0),null);
var arity = cljs.core.nth.call(null,vec__12002,(1),null);
var vec__12005 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12005,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12005,(1),null);
var vec__12008 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12008,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12008,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12008,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12008,(3),null);
...
var vec__12014 = result;
var munged_ns = cljs.core.nth.call(null,vec__12014,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12014,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12014,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12014,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12014,(4),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__12018 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__12018,(0),null);
var args = cljs.core.nth.call(null,vec__12018,(1),null);
var vec__12021 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12021,(0),null);
var name = cljs.core.nth.call(null,vec__12021,(1),null);
...
var G__12024 = (arity + (1));
var G__12025 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12026){
var vec__12027 = p__12026;
var arity = cljs.core.nth.call(null,vec__12027,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12027,(1),null);
...
return cljs.core.get.call(null,arities,p1__12030_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12031_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___12038 = arguments.length;
var i__4731__auto___12039 = (0);
while(true){
if((i__4731__auto___12039 < len__4730__auto___12038)){
args__4736__auto__.push((arguments[i__4731__auto___12039]));

var G__12040 = (i__4731__auto___12039 + (1));
i__4731__auto___12039 = G__12040;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12034){
var vec__12035 = p__12034;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12035,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12032){
var G__12033 = cljs.core.first.call(null,seq12032);
var seq12032__$1 = cljs.core.next.call(null,seq12032);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12033,seq12032__$1);
});
...
var G__12041 = arg;
var G__12041__$1 = (((G__12041 instanceof cljs.core.Keyword))?G__12041.fqn:null);
switch (G__12041__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12043__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12043__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12043__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12043__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12044 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12044,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12044,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12044,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12044,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12044,(4),null);
var arity = cljs.core.nth.call(null,vec__12044,(5),null);
...
var o__11073__auto__ = f;
return (o__11073__auto__["getBasis"]).call(o__11073__auto__);
});
/**
...
}catch (e12048){var _e__11080__auto__ = e12048;
...
var G__12049 = (obj[cljs.core.first.call(null,path)]);
var G__12050 = cljs.core.rest.call(null,path);
obj = G__12049;
path = G__12050;
continue;
} else {
...
return (function (accum,p__12051){
var vec__12052 = p__12051;
var bit = cljs.core.nth.call(null,vec__12052,(0),null);
var protocol = cljs.core.nth.call(null,vec__12052,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12055){
var vec__12056 = p__12055;
var ns = cljs.core.nth.call(null,vec__12056,(0),null);
var name = cljs.core.nth.call(null,vec__12056,(1),null);
var selector = cljs.core.nth.call(null,vec__12056,(2),null);
...
return (function (p__12060){
var vec__12061 = p__12060;
var munged_name = cljs.core.nth.call(null,vec__12061,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12061,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12061,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12059_SHARP_){
return (obj[cljs.core.first.call(null,p1__12059_SHARP_)]);
});})(name,sorted_matches,vec__12061,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
