...
return cljs.core.reduce.call(null,(function (result,p__12137){
...
var vec__12141 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12141,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12141,(1),null);
var ab = cljs.core.nth.call(null,vec__12141,(2),null);
...
return (function (){var G__12150 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12150__$1)].join('')));
