...
var G__10665 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10665,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10665;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10667){
var G__10668 = cljs.core.first.call(null,seq10667);
var seq10667__$1 = cljs.core.next.call(null,seq10667);
var G__10669 = cljs.core.first.call(null,seq10667__$1);
var seq10667__$2 = cljs.core.next.call(null,seq10667__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10668,G__10669,seq10667__$2);
});
...
var map__10674 = m;
var map__10674__$1 = (((((!((map__10674 == null))))?(((((map__10674.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10674.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10674):map__10674);
var file = cljs.core.get.call(null,map__10674__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10674__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10674__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10674,map__10674__$1,file,line,column){
return (function (p1__10673_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10673_SHARP_));
});})(map__10674,map__10674__$1,file,line,column))
...
var temp__5457__auto___10676 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10676)){
var message_10677 = temp__5457__auto___10676;
cljs.core.println.call(null,message_10677);
} else {
}
...
var temp__5457__auto___10678 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10678)){
var message_10679 = temp__5457__auto___10678;
cljs.core.println.call(null,message_10679);
} else {
}
...
var output_dir__$1 = (function (){var G__10680 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10680,"/"].join('');
} else {
return G__10680;
}
})();
...
var G__10682 = exception.stack;
var G__10682__$1 = (((G__10682 == null))?null:clojure.string.split_lines.call(null,G__10682));
var G__10682__$2 = (((G__10682__$1 == null))?null:cljs.core.get.call(null,G__10682__$1,depth));
if((G__10682__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10682__$2);
}
} else {
...
var vec__10683 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10683,(0),null);
var column = cljs.core.nth.call(null,vec__10683,(1),null);
var vec__10686 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10686,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10686,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10686,(2),null);
...
var m__$1 = (function (){var G__10689 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__10689__$1 = (((G__10689 instanceof cljs.core.Keyword))?G__10689.fqn:null);
switch (G__10689__$1) {
case "fail":
...
var G__10693 = (function (){var G__10692 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10692);
} else {
return G__10692;
}
})();
...
return cljs.core.vary_meta.call(null,G__10694,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10698 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10698,(0),null);
var types = vec__10698;
...
return cljs.core.map.call(null,(function (p__10701){
var vec__10702 = p__10701;
var ns = cljs.core.nth.call(null,vec__10702,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10702,(1),null);
return ((function (vec__10702,ns,vars__$1){
return (function (){
...
var G__10705 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__10705__$1 = (((G__10705 instanceof cljs.core.Keyword))?G__10705.fqn:null);
switch (G__10705__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1){
return (function (){
var seq__10706 = cljs.core.seq.call(null,vars__$1);
var chunk__10707 = null;
var count__10708 = (0);
var i__10709 = (0);
while(true){
if((i__10709 < count__10708)){
var v = cljs.core._nth.call(null,chunk__10707,i__10709);
var temp__5457__auto___10711 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10711)){
var t_10712 = temp__5457__auto___10711;
each_fixture_fn.call(null,((function (seq__10706,chunk__10707,count__10708,i__10709,t_10712,temp__5457__auto___10711,v,each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10712)));
});})(seq__10706,chunk__10707,count__10708,i__10709,t_10712,temp__5457__auto___10711,v,each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1))
);
} else {
}


var G__10713 = seq__10706;
var G__10714 = chunk__10707;
var G__10715 = count__10708;
var G__10716 = (i__10709 + (1));
seq__10706 = G__10713;
chunk__10707 = G__10714;
count__10708 = G__10715;
i__10709 = G__10716;
continue;
} else {
...
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10706__$1);
var G__10717 = cljs.core.chunk_rest.call(null,seq__10706__$1);
var G__10718 = c__4550__auto__;
var G__10719 = cljs.core.count.call(null,c__4550__auto__);
var G__10720 = (0);
seq__10706 = G__10717;
chunk__10707 = G__10718;
count__10708 = G__10719;
i__10709 = G__10720;
continue;
} else {
var v = cljs.core.first.call(null,seq__10706__$1);
var temp__5457__auto___10721__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10721__$1)){
var t_10722 = temp__5457__auto___10721__$1;
each_fixture_fn.call(null,((function (seq__10706,chunk__10707,count__10708,i__10709,t_10722,temp__5457__auto___10721__$1,v,seq__10706__$1,temp__5457__auto__,each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10722)));
});})(seq__10706,chunk__10707,count__10708,i__10709,t_10722,temp__5457__auto___10721__$1,v,seq__10706__$1,temp__5457__auto__,each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1))
);
} else {
}


var G__10723 = cljs.core.next.call(null,seq__10706__$1);
var G__10724 = null;
var G__10725 = (0);
var G__10726 = (0);
seq__10706 = G__10723;
chunk__10707 = G__10724;
count__10708 = G__10725;
i__10709 = G__10726;
continue;
}
} else {
...
});})(each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1))
);
});})(each_fixture_fn,G__10705,G__10705__$1,env,once_fixtures,each_fixtures,vec__10702,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10705__$1)].join('')));

}
})());
});
;})(vec__10702,ns,vars__$1))
